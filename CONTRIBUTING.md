...
جزاك الله خيراً على رغبتك في المشاركة. **المساهمات مرحّب بها جداً**، وهذا المشروع يعتمد على مساهمة المبرمجين وأهل العلم معاً.
لا يلزمك أن تكون خبيراً: تصحيح خطأ واحد مساهمة نفرح بها.
...
1. افتح [بلاغاً جديداً (Issue)](../../issues/new/choose) واختر نموذج «تصحيح علمي».
