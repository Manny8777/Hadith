    ...
    <div className="relative max-w-xl" dir="rtl">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 border border-gray-300 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-transparent"
        />
        {loading && (
